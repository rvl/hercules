...
data GithubRepo' c1 c2 c3 c4 c5 c6 c7 =
  GithubRepo
    { githubRepoId :: c1
    , githubRepoName :: c2
    ...
    , githubRepoInstallationId :: c7
    } deriving (Generic)

type GithubRepo = GithubRepo' GithubRepoId Text Text Text Text Bool (Maybe Int)

type GithubRepoReadColumns = GithubRepo' (Column PGInt4) (Column PGText) (Column PGText) (Column PGText) (Column PGText) (Column PGBool) (Column (Nullable PGInt4))

type GithubRepoWriteColumns = GithubRepo' (Column PGInt4) (Column PGText) (Column PGText) (Column PGText) (Column PGText) (Column PGBool) (Maybe (Column (Nullable PGInt4)))

type GithubRepoNullableColumns = GithubRepo' (Column (Nullable PGInt4)) (Column (Nullable PGText)) (Column (Nullable PGText)) (Column (Nullable PGText)) (Column (Nullable PGText)) (Column (Nullable PGBool)) (Column (Nullable PGInt4))

type GithubRepoNullable = GithubRepo' (Maybe GithubRepoId) (Maybe Text) (Maybe Text) (Maybe Text) (Maybe Text) (Maybe Bool) (Maybe Int)
...
githubRepoTable = TableWithSchema "hercules" "github_repos" (pGithubRepo
  GithubRepo
    ...
    , githubRepoInstallationId = optional "installation_id"
    }
  )
...
---- Types for table: github_installation ----

data GithubInstallation' c1 c2 c3 =
  GithubInstallation
    { githubInstallationId :: c1
    , githubInstallationAppId :: c2
    , githubInstallationAccountId :: c3
    } deriving Generic

type GithubInstallation = GithubInstallation' Int Int Int

type GithubInstallationReadColumns = GithubInstallation' (Column PGInt4) (Column PGInt4) (Column PGInt4)

type GithubInstallationWriteColumns = GithubInstallation' (Column PGInt4) (Column PGInt4) (Column PGInt4)

type GithubInstallationNullableColumns = GithubInstallation' (Column (Nullable PGInt4)) (Column (Nullable PGInt4)) (Column (Nullable PGInt4))

type GithubInstallationNullable = GithubInstallation' (Maybe Int) (Maybe Int) (Maybe Int)

fromNullableGithubInstallation :: GithubInstallationNullable -> Maybe GithubInstallation
fromNullableGithubInstallation = fromNullable

$(makeAdaptorAndInstance "pGithubInstallation" ''GithubInstallation')

githubInstallationTable :: Table GithubInstallationWriteColumns GithubInstallationReadColumns
githubInstallationTable = TableWithSchema "hercules" "github_installation" (pGithubInstallation
  GithubInstallation
    { githubInstallationId = required "id"
    , githubInstallationAppId = required "app_id"
    , githubInstallationAccountId = required "account_id"
    }
  )

instance ToJSON GithubInstallation where
instance ElmType GithubInstallation where
...
pgGithubRepo = pGithubRepo GithubRepo
  ...
  , githubRepoInstallationId = fmap (toNullable . pgInt4)
  }
...
pgGithubInstallation :: GithubInstallation -> GithubInstallationWriteColumns
pgGithubInstallation = pGithubInstallation GithubInstallation
  { githubInstallationId = pgInt4
  , githubInstallationAppId = pgInt4
  , githubInstallationAccountId = pgInt4
  }
